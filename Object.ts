 ...
 */
export function isArray<Expected extends ArrayLike<unknown>, Initial extends unknown>(obj:Initial):obj is Initial extends Expected?Initial:never{
 ...
 * @param obj The object that you want to check
 */
export function isExtendedArray<Expected extends Exclude<ArrayLike<unknown>, Array<unknown>>, Initial extends unknown>(obj:Initial):obj is Initial extends Array<unknown>?never:Initial extends Expected?Initial:never{
 ...
 * @param obj The object that you want to check
 */
export function isLiteralArray<Expected extends Array<unknown>, Initial extends unknown>(obj:Initial):obj is Initial extends Expected?Initial:never{
   const res = isArray<Expected, Initial>(obj) 
   if (!res) return false;
   return (obj instanceof Array)
}
